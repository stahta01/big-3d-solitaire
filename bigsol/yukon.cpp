...
*/
// yukon.cpp: implementation of the yukon class.
//
//////////////////////////////////////////////////////////////////////
...
// Recrear las golums
// LA COLUMNA MAZO
golum[0]=new Ccolumna(-0.60f,0.3f,-1.2f,0,false,0,0.0000015f,0.0000015f,0.00015f,MAZO_NO,0);
// LA "COLUMNA" PILA
golum[1]=new Ccolumna(-0.24f,0.3f,-1.2f,4,false,0,0.0170f,0.f,0.00005f,MAZO_NO,0);
// LAS COLUMNAS (7)
golum[ 2]=new Ccolumna(-0.36f,0.3f,-1.2f,2,true,0,0.f,-0.04f,0.0001f,HUECO_K,0);
golum[ 3]=new Ccolumna(-0.24f,0.3f,-1.2f,2,true,0,0.f,-0.04f,0.0001f,HUECO_K,0);
golum[ 4]=new Ccolumna(-0.12f,0.3f,-1.2f,2,true,0,0.f,-0.04f,0.0001f,HUECO_K,0);
golum[ 5]=new Ccolumna( 0.00f,0.3f,-1.2f,2,true,0,0.f,-0.04f,0.0001f,HUECO_K,0);
golum[ 6]=new Ccolumna( 0.12f,0.3f,-1.2f,2,true,0,0.f,-0.04f,0.0001f,HUECO_K,0);
golum[ 7]=new Ccolumna( 0.24f,0.3f,-1.2f,2,true,0,0.f,-0.04f,0.0001f,HUECO_K,0);
golum[ 8]=new Ccolumna( 0.36f,0.3f,-1.2f,2,true,0,0.f,-0.04f,0.0001f,HUECO_K,0);
// LAS FINALES (4)
...
golum[36]=new Ccolumna( 0.605f,-0.55f,-1.2f,4,false,0,0.0008f,-0.04f,0.0008f,FINAL,0);
...
void yukon::fase_presentacion()
{
mueve_colum_reparto(0,2,true);mueve_colum_reparto(0,3,false);
...
mueve_colum_reparto(0,3,true);mueve_colum_reparto(0,4,false);
mueve_colum_reparto(0,5,false);mueve_colum_reparto(0,6,false);
mueve_colum_reparto(0,7,false);mueve_colum_reparto(0,8,false);
...
mueve_colum_reparto(0,3,true);mueve_colum_reparto(0,4,true);
mueve_colum_reparto(0,5,true);mueve_colum_reparto(0,6,false);
mueve_colum_reparto(0,7,false);mueve_colum_reparto(0,8,false);
...
mueve_colum_reparto(0,5,true);mueve_colum_reparto(0,6,true);
mueve_colum_reparto(0,7,true);mueve_colum_reparto(0,8,true);
...
void yukon::busca_sitio_boton_derecho()
{
    // Nada que hacer ya que no quedan cartas en el mazo tras repartir
}

//*****************************************************//
// Devuelve TRUE si la carta es seleccionable
// segun las reglas del juego
bool yukon::es_seleccionable(int cc,int c)
//****************************************************//
{
lista *alfa=NULL;
int b=0;
...
for(int k=b;k<golum[c]->num_cartas;k++)
	...
	else	// Se puede seleccionar cualquier carta
		{
		alfa=alfa->sig;
...
bool yukon::mover(int ini, int fin)
//***********************************//
{
lista *alfa=NULL;
int karta=NOCARTA;
