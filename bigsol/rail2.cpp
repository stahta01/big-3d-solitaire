...
// rail2.cpp: implementation of the rail2 class.
//
//////////////////////////////////////////////////////////////////////
...
// Recrear las golums
// LA COLUMNA MAZO
golum[ 0]=new Ccolumna(-0.32f,0.4f,-1.2f,0,true,0,0.0000015f,0.0000015f,0.0001f,MAZO_NO,0);
// LA "COLUMNA" PILA
golum[ 1]=new Ccolumna(-0.18f,0.4f,-1.2f,1,true,0,0.0000015f,0.00012f,0.0001f,MAZO_NO,0);
// LAS COLUMNAS (4)
...
golum[ 6]=new Ccolumna( 0.30f,0.2f,-1.2f,2,true,0,0.f,-0.03f,0.0001f,HUECO,0);
// LAS FINALES (8)
golum[ 7]=new Ccolumna(-0.03f, 0.4f,-1.2f,3,false,0,0.0005f,0.00025f,0.0008f,FINAL_G,0);
golum[ 8]=new Ccolumna( 0.06f  , 0.4f,-1.2f,3,false,0,0.0005f,0.00025f,0.0008f,FINAL_G,0);
golum[ 9]=new Ccolumna( 0.15f, 0.4f,-1.2f,3,false,0,0.0005f,0.00025f,0.0008f,FINAL_G,0);
golum[10]=new Ccolumna( 0.24f, 0.4f,-1.2f,3,false,0,0.0005f,0.00025f,0.0008f,FINAL_G,0);
golum[11]=new Ccolumna( 0.33f, 0.4f,-1.2f,3,false,0,0.0005f,0.00025f,0.0008f,FINAL_G,0);
golum[12]=new Ccolumna( 0.42f, 0.4f,-1.2f,3,false,0,0.0005f,0.00025f,0.0008f,FINAL_G,0);
golum[13]=new Ccolumna( 0.51f, 0.4f,-1.2f,3,false,0,0.0005f,0.00025f,0.0008f,FINAL_G,0);
golum[14]=new Ccolumna( 0.60f, 0.4f,-1.2f,3,false,0,0.0005f,0.00025f,0.0008f,FINAL_G,0);
// LAS NO UTILIZABLES
...
num_golum=15;	// Siempre es una mas
mazo_juego=104;
...
// Posicion final del juego, para jugar
posX=0.0638f;
posY=-0.278f;
posZ=-0.261f;
viewX=0.0638f;
...
bool rail2::mover(int ini, int fin)
//***********************************//
{
lista *alfa=NULL;
int karta=NOCARTA;
